...
const PriceManagement = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border shadow-sm">
        <div className="flex flex-col space-y-1.5 p-6">
          <h3 className="text-xl font-semibold leading-none tracking-tight">Surge Pricing Settings</h3>
          <p className="text-gray-600">Configure automatic surge pricing conditions</p>
        </div>
        <div className="p-6 pt-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Peak Hours</label>
                ...
                <p className="text-xs text-gray-500 mt-1">Morning peak hours</p>
              </div>
              
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Evening Peak</label>
                <div className="grid grid-cols-2 gap-2">
                  <input
                    type="time"
                    defaultValue="17:00"
                ...
                <p className="text-xs text-gray-500 mt-1">Evening peak hours</p>
              </div>
            </div>

            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">High Demand Threshold</label>
                <input
                  type="number"
                  defaultValue="85"
                  className="flex h-10 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                />
                <p className="text-xs text-gray-500 mt-1">% of drivers busy to trigger surge</p>
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Auto Surge Multiplier</label>
                <input
                  type="number"
                  step="0.1"
                  defaultValue="1.8"
                  className="flex h-10 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                />
                <p className="text-xs text-gray-500 mt-1">Automatic surge multiplier</p>
              </div>
            </div>
          </div>
          
          <div className="mt-6">
            <button className="inline-flex items-center justify-center gap-2 rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white ring-offset-white transition-colors hover:bg-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2">
              Save Surge Settings
            </button>
          </div>
        </div>
